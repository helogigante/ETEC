...
public class TelaNutricionista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtcfn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtcfnActionPerformed(evt);
            }
        });
        txtcfn.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtcfnKeyPressed(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                            ...
                            .addGap(64, 64, 64)
                            .addComponent(txtcfn, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtcfn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
    ...
    private void txtcfnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcfnActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtcfnActionPerformed
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        nut.salvar(txtnome.getText(), Integer.parseInt(txtcfn.getText()), txttelefone.getText(), txtespecialidade.getText());
        lista[i]=nut;
        i++;
        limpar();
    }//GEN-LAST:event_btnSalvarActionPerformed

    private void txtcfnKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcfnKeyPressed
        int status=0;
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            int codigo = Integer.parseInt(txtcfn.getText());
            for(int x=0;x<i;x++){
                if(lista[x].getcfn()==codigo){
                    status=1;
                    JOptionPane.showMessageDialog(null, lista[x].exibir());
                }
            }
            if(status==0){
    ...
    }//GEN-LAST:event_txtcfnKeyPressed
